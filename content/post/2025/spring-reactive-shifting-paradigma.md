...
| `Map` | Operator yang digunakan untuk mendapatkan obyek yang dijanjikan dari sebuah stream, proses ini menjadi synchronous karena obyek menjadi sebuah value yang harus direturn. i.e mendapatkan data pelanggan | ![](https://reactivex.io/documentation/operators/images/map.i.png) |
| `FlatMap` | Operator yang digunakan untuk mendapatkan return dari perintah asynchronous lain, proses ini merupakan non-blocking karena returnnya adalah sebuah stream. i.e mendapatkan data pelanggan lalu mengirimkan email ke pelanggan tersebut | ![](https://reactivex.io/documentation/operators/images/flatMap.c.png) |
