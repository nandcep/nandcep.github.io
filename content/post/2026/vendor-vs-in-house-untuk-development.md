...
| Spending investment yang **membebani perusahaan** dan **celah keamanan** | Hal yang saya paling rasakan, software yang dibeli untuk produktivitas internal seperti tiket, versioning, dan automasi justru dioptimalkan oleh vendor tidak sebanding dengan deduksi harga jasa. Sehingga membebani lisensi tahunan, itu juga kalau vendor patuh karena sering kali jadi celah vendor melakukan _fraud_ untuk mengambil source code karena bebas masuk seperti organik. | _All_ |
...
6. Menerapkan cost sharing lisensi asset kepada vendor, bagaimana pun mereka juga sebagai pengguna dengan formula dasar _nominal proyek = nominal proyek - (harga lisensi x jumlah pengguna dari vendor)_.
